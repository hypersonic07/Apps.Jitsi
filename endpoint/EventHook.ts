// HTTP HOOK TO RECIEVE ROOM CLOSURE NOTICES FROM PROSODY
// Requires simple JSON containing "id" with the room ID given by Rocket.Chat and a Preshared Key

// ORIGINAL CODE is from the BigBlueButton plugin for Rocket.Chat, shamelessly motified so Jitsi Users can be happy too :)
